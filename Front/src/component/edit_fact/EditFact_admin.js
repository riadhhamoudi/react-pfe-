...
import NavbarF from '../navbar/Navbar_admin';
import "./EditFact.css";
...
function EditFact() {
    ...
    const [formData, setFormData] = useState({
        dossier: 'Direction centrale des finance DCF',
        fournisseur: '',
        periode_conso: '',
        num_fact: '',
        device: '',
        ...
        <div className="allF1">
            ...
            <div className="edit-facture-form">
                <form className="edit_form" onSubmit={handleFormSubmit}>
                    <div className="D_1">
                        <label htmlFor="dossier">direction :</label>
                        <input type="text" id="dossier" name="dossier" placeholder="Dossier" value={formData.dossier} onChange={handleInputChange} defaultValue={"Direction centrale des finances DCF"} readOnly />
                    </div>
                    <div className="D_1">
